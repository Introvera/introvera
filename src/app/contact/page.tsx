  ...
  return (
    <div className="w-full bg-background min-h-screen pt-28 pb-20 overflow-hidden">
         ...
         <div className="w-full bg-foreground/[0.02] border border-foreground/10 rounded-[2.5rem] p-8 md:p-12 lg:p-16 shadow-[0_20px_60px_rgba(0,0,0,0.8)]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 mb-16">
               ...
               <div className="flex flex-col gap-8">
                  <h3 className="text-3xl font-medium text-foreground">Send Us a Message</h3>
                  <ContactForm />
               </div>

               <div className="flex flex-col gap-5">
                  
                  <a href="mailto:contact@introvera.com" className="w-full bg-foreground/5 border border-foreground/10 rounded-2xl p-6 flex items-center gap-6 hover:bg-foreground/10 transition-colors group cursor-pointer">
                     <div className="shrink-0">
                        <Mail size={32} strokeWidth={1.5} className="text-foreground group-hover:text-[var(--color-accent)] transition-colors" />
                     </div>
                     <div className="flex flex-col gap-1">
                        <h4 className="text-foreground font-semibold text-base">Email</h4>
                        <p className="text-foreground/70 text-sm">contact@introvera.com</p>
                     </div>
                  </a>

                  <a href="tel:+94783640894" className="w-full bg-foreground/5 border border-foreground/10 rounded-2xl p-6 flex items-center gap-6 hover:bg-foreground/10 transition-colors group cursor-pointer">
                     <div className="shrink-0">
                        <Phone size={32} strokeWidth={1.5} className="text-foreground group-hover:text-[var(--color-accent)] transition-colors" />
                     </div>
                     <div className="flex flex-col gap-1">
                        <h4 className="text-foreground font-semibold text-base">Phone</h4>
                        <p className="text-foreground/70 text-sm">+94 78 364 0894</p>
                     </div>
                  </a>

                  <div className="w-full bg-foreground/5 border border-foreground/10 rounded-2xl p-6 flex items-center gap-6 hover:bg-foreground/10 transition-colors group cursor-pointer">
                     <div className="shrink-0">
                        <MapPin size={32} strokeWidth={1.5} className="text-foreground group-hover:text-[var(--color-accent)] transition-colors" />
                     </div>
                     <div className="flex flex-col gap-1">
                        <h4 className="text-foreground font-semibold text-base">Location</h4>
                        <p className="text-foreground/70 text-sm leading-relaxed max-w-[200px]">Introvera Pvt Ltd, <br />275/3, New Kandy Road,<br/>Biyagama, Sri Lanka</p>
                     </div>
                  </div>

                  <a href="https://wa.me/94783640894" target="_blank" rel="noopener noreferrer" className="w-full bg-foreground/5 border border-foreground/10 rounded-2xl p-6 flex items-center gap-6 hover:bg-foreground/10 transition-colors group cursor-pointer">
                     <div className="shrink-0">
                        <FaWhatsapp size={32} className="text-foreground group-hover:text-[var(--color-accent)] transition-colors" />
                     </div>
                     <div className="flex flex-col gap-1">
                        <h4 className="text-foreground font-semibold text-base">WhatsApp</h4>
                        <p className="text-foreground/70 text-sm">Chat with us on WhatsApp</p>
                     </div>
                  </a>
            ...
            <div className="flex flex-col gap-8">
               <div className="flex flex-col gap-2">
                  <h3 className="text-3xl font-medium text-foreground">Find Us</h3>
      ...
      <FadeInSection className="max-w-7xl mx-auto px-6 relative z-10 mt-20 mb-32">
        <div className="bg-foreground/[0.02] border border-foreground/5 rounded-3xl p-10 md:p-16">
          <div className="text-center mb-12">
            <h2 className="text-2xl md:text-3xl font-medium text-foreground mb-4">Global Software Development Services</h2>
            <p className="text-foreground/70 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">While our development center is proudly based in Sri Lanka, we operate on a global scale. We provide overlapping working hours and seamless remote communication for clients worldwide.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            <div className="p-4 border-t border-foreground/10">
              <span className="block text-foreground font-medium mb-1">America</span>
              <span className="text-[var(--color-accent)] text-xs uppercase tracking-wider font-semibold">Active Clients</span>
            </div>
            <div className="p-4 border-t border-foreground/10">
              <span className="block text-foreground font-medium mb-1">Europe</span>
              <span className="text-[var(--color-accent)] text-xs uppercase tracking-wider font-semibold">Active Clients</span>
            </div>
            <div className="p-4 border-t border-foreground/10">
              <span className="block text-foreground font-medium mb-1">Middle East</span>
              <span className="text-[var(--color-accent)] text-xs uppercase tracking-wider font-semibold">Active Clients</span>
            </div>
            <div className="p-4 border-t border-foreground/10">
              <span className="block text-foreground font-medium mb-1">Asia Pacific</span>
              <span className="text-[var(--color-accent)] text-xs uppercase tracking-wider font-semibold">Active Clients</span>
            </div>
          </div>
        </div>
      ...
      <FadeInSection className="max-w-7xl mx-auto px-6 relative z-10 mb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="flex flex-col gap-4">
            ...
            <h3 className="text-xl font-medium text-foreground">Initial Discovery Call</h3>
            <p className="text-foreground/70 text-sm leading-relaxed">Within 24 hours, we&apos;ll schedule a free consultation to understand your business goals, target audience, and the technical requirements of your POS system, mobile app, or custom software.</p>
          </div>
          <div className="flex flex-col gap-4">
            ...
            <h3 className="text-xl font-medium text-foreground">Scope of Work & Proposal</h3>
            <p className="text-foreground/70 text-sm leading-relaxed">Our team will draft a detailed Scope of Work (SOW) including the project timeline, milestones, and a transparent cost estimate. Specific technical architecture details can also be provided upon request.</p>
          </div>
          <div className="flex flex-col gap-4">
            ...
            <h3 className="text-xl font-medium text-foreground">Project Kickoff</h3>
            <p className="text-foreground/70 text-sm leading-relaxed">Once approved, we assemble your dedicated team of developers, designers, and project managers and immediately begin the UI/UX design and agile development process.</p>
          </div>
        </div>
      </FadeInSection>
      ...
      <FadeInSection className="max-w-7xl mx-auto px-6 relative z-10 mb-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-foreground/[0.02] border border-foreground/5 rounded-2xl p-8 hover:border-[var(--color-accent)]/30 transition-all duration-300">
            <h3 className="text-lg font-medium text-foreground mb-3">Do you sign NDAs (Non-Disclosure Agreements)?</h3>
            <p className="text-foreground/70 text-sm leading-relaxed">Yes. We take your intellectual property and data security very seriously. We are happy to sign a standard NDA before you share any confidential details about your software project.</p>
          </div>
          <div className="bg-foreground/[0.02] border border-foreground/5 rounded-2xl p-8 hover:border-[var(--color-accent)]/30 transition-all duration-300">
            <h3 className="text-lg font-medium text-foreground mb-3">How do you handle time zone differences?</h3>
            <p className="text-foreground/70 text-sm leading-relaxed">We optimize our team schedules to ensure a minimum of 3-4 hours of overlapping time with your timezone (no matter where you are located) for daily standups and live collaboration.</p>
          </div>
          <div className="bg-foreground/[0.02] border border-foreground/5 rounded-2xl p-8 hover:border-[var(--color-accent)]/30 transition-all duration-300">
            <h3 className="text-lg font-medium text-foreground mb-3">What is the best way to contact support?</h3>
            <p className="text-foreground/70 text-sm leading-relaxed">For all inquiries and support, the best way to reach us is by emailing contact@introvera.com, sending us a message on WhatsApp, or calling our mobile line. We prioritize rapid responses across all these channels.</p>
          </div>
          <div className="bg-foreground/[0.02] border border-foreground/5 rounded-2xl p-8 hover:border-[var(--color-accent)]/30 transition-all duration-300">
            <h3 className="text-lg font-medium text-foreground mb-3">Do you offer white-label development services?</h3>
            <p className="text-foreground/70 text-sm leading-relaxed">Yes, we partner with marketing agencies and IT consultancies globally to provide white-label UI/UX design, mobile app development, and web development services under their brand.</p>
          </div>
        </div>
      </FadeInSection>
