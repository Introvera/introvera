...
export default function About() {
  return (
    <section id="about" className="w-full bg-background text-foreground py-16 sm:py-20">
          ...
          <div className="lg:w-7/12 flex flex-col justify-between pt-4">
            ...
            <div className="space-y-12 mb-16 lg:mb-0">
              <FadeInSection className="flex items-start gap-5">
                <div className="mt-1 w-7 h-7 rounded-full border border-foreground/30 flex items-center justify-center shrink-0">
                  <ChevronRight size={14} className="text-foreground" strokeWidth={2} />
                </div>
            ...
            <FadeInSection className="pb-4">
              <div className="grid grid-cols-2 md:flex md:items-center md:justify-between gap-y-10">
                <div className="flex flex-col items-center gap-4 text-center flex-1">
                  <CloudLightning size={32} className="text-foreground" strokeWidth={1.5} />
                  <span className="text-[13px] font-medium text-foreground/70">Fast Delivery</span>
                </div>

                <div className="hidden md:block w-[1px] h-10 bg-foreground/25 shrink-0" />

                <div className="flex flex-col items-center gap-4 text-center flex-1">
                  <Lock size={32} className="text-foreground" strokeWidth={1.5} />
                  <span className="text-[13px] font-medium text-foreground/70">Secure & Reliable</span>
                </div>
                
                <div className="hidden md:block w-[1px] h-10 bg-foreground/25 shrink-0" />

                <div className="flex flex-col items-center gap-4 text-center flex-1">
                  <Users size={32} className="text-foreground" strokeWidth={1.5} />
                  <span className="text-[13px] font-medium text-foreground/70">Dedicated Team</span>
                </div>

                <div className="hidden md:block w-[1px] h-10 bg-foreground/25 shrink-0" />

                <div className="flex flex-col items-center gap-4 text-center flex-1">
                  <Clock size={32} className="text-foreground" strokeWidth={1.5} />
                  <span className="text-[13px] font-medium text-foreground/70">24/7 Support</span>
                </div>
              </div>
            </FadeInSection>
