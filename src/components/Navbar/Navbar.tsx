        ...
        <ul className="hidden md:flex items-center gap-1 lg:gap-2">
          {navLinks.map((link) => {
            ...
            <li key={link.label}>
              <Link
                href={link.href}
                className={`relative px-4 py-2 text-m transition-colors duration-300 rounded-lg hover:bg-[var(--color-accent-subtle)] group ${isActive ? "text-[var(--color-accent)] font-medium" : "font-light text-white hover:text-[var(--color-accent)]"}`}
              >
                {link.label}
            ...
            {navLinks.map((link) => {
              ...
              <li key={link.label}>
                <Link
                  ...
                  className={`block px-4 py-3 text-sm rounded-lg transition-colors duration-200 ${isActive ? "font-semibold text-[var(--color-accent)] bg-[var(--color-accent-subtle)]" : "font-medium text-[var(--color-text-secondary)] hover:text-white hover:bg-[var(--color-accent-subtle)]"}`}
                >
                  {link.label}
                </Link>
              </li>
