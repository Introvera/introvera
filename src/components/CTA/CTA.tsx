...
export default function CTA() {
  return (
    <section className="relative w-full bg-black py-16 sm:py-20" id="cta">
      <div className="max-w-7xl mx-auto px-6 relative z-10 w-full flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20">
        
        <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
          <h2 className="text-4xl sm:text-5xl lg:text-[50px] font-medium leading-[1.15] text-white tracking-tight mb-10">
